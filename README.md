...
- **🎯 Высокая точность**: 77.36% точность Top-1, 96.65% точность Top-5 на 120 породах
...
- **⚡ Эффективность**: Компактный размер модели (~25 МБ), быстрая инференция (~50 мс на изображение)
...
| Метрика | Значение |
|---------|----------|
| **Точность Top-1** | 77.36% |
| **Точность Top-5** | 96.65% |
| **Время обучения** | ~2 часа (Tesla P100) |
...
[![Made with ❤️](https://img.shields.io/badge/Made_with-❤️_and_🐕-red?style=for-the-badge)]()
<br/>
